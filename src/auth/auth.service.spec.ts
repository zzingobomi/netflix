...
describe('AuthService', () => {
  ...
  describe('parseBasicToken', () => {
    it('should parse a valid Basic Token', () => {
      const rawToken = 'Basic c3lAenppbmdvYm9taS5jb206dGVzdHRlc3Q=';
      const result = authService.parseBasicToken(rawToken);

      const decode = { email: 'sy@zzingobomi.com', password: 'testtest' };
    ...
    it('should throw an error for invalid token format', () => {
      ...
      // promise 가 아닌 일반 에러를 던지므로 toThrow() 사용
  ...
  describe('authenticate', () => {
    it('should authenticate a user with correct credential', async () => {
